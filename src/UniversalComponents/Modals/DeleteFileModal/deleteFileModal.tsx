    ...
    render() {
        ...
        return (
            <div className="col-md-12 col-12">
                <div className="row modal" id="deleteModal" aria-labelledby="deleteModal" aria-hidden="true" data-backdrop="false">
                            ...
                            <div className="col-md-12 modal-content">
                                <div className="row">
                                    <div className="col-md-12 my-3">
                                        ...
                                        <span id="delete-btn-outside-click" data-dismiss="modal" style={{ display: 'none' }}><img src="/static_images/close-modal-icn.svg" /></span>
                                        </div>
                                        ...
                                        {deleteStatus === -1 && <div className="modal-body modal-subtitle" style={{ margin: '0 25%', lineHeight: '28px' }}>
                                            <span data-dismiss="modal" className="mailto-riverus">Cancel</span>
                                            <button className="upload-yellow-btn" style={{ float: 'right', padding: '2% 10%' }} onClick={() => deleteFile(fileId)}>Delete</button>
                                        </div>}
                                    </div>
                                </div>
                                {this.switchDeleteStatus()}
                                {deleteStatus !== -1 && <div className="col-md-12 modal-subtitle" style={{ textAlign: 'center', lineHeight: '40px' }}>
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="row">
                                        <div className="modal-body modal-subtitle" style={{ margin: '0 25%', lineHeight: '28px' }}>
                                            <span data-dismiss="modal" className="mailto-riverus">Cancel</span>
                                            <button className="upload-yellow-btn" style={{ float: 'right', padding: '2% 10%' }} onClick={() => deleteFile(fileId)}>Retry</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
