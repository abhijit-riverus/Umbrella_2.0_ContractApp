    ...
    return (
        <div className="row">
            <div className="col-md-3">
                <QuickLookCard title={fileInfo.length.toString()} subTitle={'totalUploads'} selectedFilter={selectedFilter} selectFilter={selectFilter} isClickable={fileInfo.length > 0 ? true : false} />
            </div>
            {/* <div className="col-md-3">
            ...
            <div className="col-md-3">
                <QuickLookCard title={getUploadSize(fileInfo).toString()} subTitle={'uploadSize'} selectedFilter={selectedFilter}  selectFilter={selectFilter} isClickable={false} />
            </div>
        </div>
    );
}
