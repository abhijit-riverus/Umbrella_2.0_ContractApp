import { GetUserUploadsSuccess, GETUSERUPLOADS, GetUserUploads, GETUSERUPLOADS_SUCCESS, GetUserUploadsFailure, GETUSERUPLOADS_FAILURE, ChangeStatus, CHANGESTATUS, ChangeStatusSuccess, CHANGESTATUS_SUCCESS, DeleteFile, DeleteFileSuccess, DeleteFileFailure, DELETEFILE, DELETEFILE_SUCCESS, DELETEFILE_FAILURE, SAVEDELETEDETAILS, SaveDeleteDetails } from "./def";
...
export default class HistoryActionGenerator {
    ...
    public static getUserUploadsSuccess(userUploads: FileInfo[]): GetUserUploadsSuccess {
        return {
    ...
    public static saveDeleteDetails(documentName: string, uniqueFileId: number): SaveDeleteDetails {
        return {
