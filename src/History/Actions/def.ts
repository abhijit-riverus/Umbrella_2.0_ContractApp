...
export const GETUSERUPLOADS_SUCCESSNEW = "GETUSERUPLOADS_SUCCESSNEW";
export type GETUSERUPLOADS_SUCCESSNEW = typeof GETUSERUPLOADS_SUCCESSNEW;
...
export interface GetUserUploadsSuccessNew {
