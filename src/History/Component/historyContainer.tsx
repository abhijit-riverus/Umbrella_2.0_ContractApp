...
export default class HistoryContainer extends Component<Props, State> {
    ...
    switchRender() {
        ...
        if (historyLoader) {
            ...
            return (
                <>
                    {uploadsArray.length > 0 && <div className="row">
                                    ...
                                    <Scrollable maxHeight={370} minHeight={'50vh'}>
                                        {uploadsArray.map((file, i) =>
                                            <React.Fragment key={i}>
                                                <FileListComponent file={file} history={history} from={"uploads"} saveDeleteDetails={saveDeleteDetails} />
                                            </React.Fragment>
                                        )}
                                    </Scrollable>
                                </div>
                        ...
                        <div className="col-md-10 mt-3 ml-5">
                            <div className="row">
                                <div className="col-md-12">
                                    <QuickLook fileInfo={userUploads} selectFilter={this.selectFilter} selectedFilter={selectedFilter} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-9"></div>
                                {userUploads.length > 0 &&
                                    <div className="col-md-3 message-link" onClick={() => window.location.href = '/addfiles'}>
