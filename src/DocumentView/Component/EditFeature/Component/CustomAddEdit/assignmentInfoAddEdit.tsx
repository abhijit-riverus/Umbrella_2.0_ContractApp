...
export default class AssignmentInfoAddEdit extends Component<Props, State> {
    ...
    render() {
        let { editOptionSelected, dataPointName, savedHighlightedSentences, saveHighlightedSentences} = this.props;
            ...
            <div className="row toc-content toc-content-default">
                <div className="col-md-12">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 my-2 ml-0" style={{ margin: 'auto' }} onClick={() => this.setState({ requiredString: 'Yes' })}>
                            <img className="cursor-pointer" src={requiredString === 'Yes' ? "/static_images/radio-active.svg" : "/static_images/radio-inactive.svg"} alt="radio-btn" />&nbsp;&nbsp;
                                <span>Yes</span>
                        </div>
                        <div className="col-md-3 my-2 ml-0" style={{ margin: 'auto' }} onClick={() => this.setState({ requiredString: 'No' })}>
                            <img className="cursor-pointer" src={requiredString === 'No' ? "/static_images/radio-active.svg" : "/static_images/radio-inactive.svg"} alt="radio-btn" />&nbsp;&nbsp;
                                <span>No</span>
                        </div>
                    </div>
    ...
    getAddedAndDeletedTableCells(changedLinkedTableCells: tableInfo[] | null, previousLinkedTableCells: tableInfo[]) {
        ...
        for (let i = 0; i < addedTableCells.length; i++) {
            upsertSentences.push({
                ...
                requirement: addedTableCells[i].requirement
            });
        }
