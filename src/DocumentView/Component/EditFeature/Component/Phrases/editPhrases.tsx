...
export default class EditPhrases extends Component<Props, State> {
    ...
    onSave() {
        ...
        let oldPhrasesArray = getPhrasesFromChild(this.props.savedInsight);
        ...
        let editedPhrases = this.getAddedAndDeletedPhrases(oldPhrases, changedPhrases)
        let editedTableCells = this.getEditedTableCellPhrases(oldTableCells, changedTableCells);
