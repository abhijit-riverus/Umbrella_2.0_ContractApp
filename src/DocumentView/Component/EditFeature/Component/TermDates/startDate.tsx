...
interface Props {
    ...
    editStartDates: (startDates: LinkDateRequest) => void;
    savedDates: any;
...
export default class StartDate extends Component<Props, State> {
    ...
    componentDidMount() {
        let startDates = getDatesFromChild(this.props.savedDates)
        this.props.saveHighlightedDates(startDates);
    }
                ...
                <div className="col-md-12">
                    ...
                    <div className="row">
                        <div className="col-md-12 mb-3 edit-title-header">
                            Add/edit the start date to your contract here...
                        </div>
                    </div>
                    <div className="row">
            ...
            return (
                <>
                    ...
                    {/* <div className="row">
                        ...
                        <div className="col-md-4 align-right">
                            {dateInAddMode !== null && dateInAddMode.phrase !== '' && dateInAddMode.paraId !== null && dateInAddMode.paraId !== -1 ?
    ...
    onSave() {
        ...
        this.props.editStartDates(tempDateRequest);
        this.props.saveHighlightedDates(null);
        this.props.saveDateInAddEditMode(null);
        this.props.saveHighlightedTableCells(null);
        this.props.saveHighlightedId(null);
