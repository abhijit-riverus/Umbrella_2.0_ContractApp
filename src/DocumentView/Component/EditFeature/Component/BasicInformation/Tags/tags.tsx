...
interface Props {
    ...
    otherTags: TagData[];
    listOtherTags: () => void;
    editTags: (natureTagId: number, typeTagId: number, othersTagId: number[], isBulkAction: boolean) => void;
...
export default class Tags extends Component<Props, State> {
    ...
    onUserGroupChange = (value: OnChangeValue<groupOption, true>, actionMeta: ActionMeta<groupOption>) => {
        ...
        return (
            <div className="row toc-content toc-content-default">
                <div className="col-md-12">
                    ...
                    <div className="row">
                        <div className="col-md-12 edit-title-header">Add tags to your contract here...</div>
                    </div>
                    <div className="row">
                        <div className="col-md-12 my-3">
                            <TagComponents
                                ...
                                otherTags={otherTags}
                                getNature={(natureTagId) => this.setState({ natureTagId: natureTagId })}
                                getType={(typeTagId) => this.setState({ typeTagId: typeTagId })}
                                getOthers={(othersTagId) => this.setState({ othersTagId: othersTagId })}
                                tags={tags}
